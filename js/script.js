...
const translations = {
  hi: {
    ...
    "Responsible Play": "जिम्मेदार खेल", "Adults aged 21+": "केवल 21+ वयस्क",
  ...
  es: {
    ...
    "Private Rooms": "Salas privadas", "Play with friends": "Juega con amigos", "Fast Gameplay": "Juego rápido", "Smooth experiences": "Experiencia fluida", "Responsible Play": "Juego responsable", "Adults aged 21+": "Solo mayores de 21 años",
  ...
  "pt-BR": {
    ...
    "Private Rooms": "Salas privadas", "Play with friends": "Jogue com amigos", "Fast Gameplay": "Jogabilidade rápida", "Smooth experiences": "Experiência fluida", "Responsible Play": "Jogo responsável", "Adults aged 21+": "Somente maiores de 21 anos",
  ...
  bn: {
    ...
    "Private Rooms": "প্রাইভেট রুম", "Play with friends": "বন্ধুদের সঙ্গে খেলুন", "Fast Gameplay": "দ্রুত গেমপ্লে", "Smooth experiences": "মসৃণ অভিজ্ঞতা", "Responsible Play": "দায়িত্বশীল খেলা", "Adults aged 21+": "শুধু ২১+ প্রাপ্তবয়স্ক",
  ...
  fil: {
    ...
    "Private Rooms": "Mga Pribadong Room", "Play with friends": "Maglaro kasama ang mga kaibigan", "Fast Gameplay": "Mabilis na Gameplay", "Smooth experiences": "Maayos na karanasan", "Responsible Play": "Responsableng Paglalaro", "Adults aged 21+": "Para lamang sa 21+",
